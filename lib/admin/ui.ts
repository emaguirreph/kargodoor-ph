...
export function page(
  ...
  return new Response(
    `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="icon" href="/kargodoor-app-icon.png" type="image/png"><link rel="apple-touch-icon" href="/kargodoor-app-icon.png"><link rel="manifest" href="/manifest.webmanifest"><title>${esc(title)} | KargoDoor Admin</title><style>
