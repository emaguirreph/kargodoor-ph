...
</style></head><body><main><header><img src="/assets/kargodoor-logo-approved.png" alt="KargoDoor PH"><div><h1>${esc(title)}</h1><p>${esc(user)}</p></div></header>${user ? `<nav aria-label="Admin"><a href="/admin/dashboard">Dashboard</a><a href="/admin/customers">Customers</a><a href="/admin/shipments">Shipments</a><a href="/admin/invoices">Invoices</a><a href="/admin/finance">Finance</a>${canWrite ? '<a href="/admin/activity">Activity log</a><a href="/admin/import-export">Import / Export</a><a href="/admin/tracking-editor">Tracking editor</a>' : ""}<a href="/cdn-cgi/access/logout">Sign out</a></nav>` : ""}${body}</main></body></html>`,
    {
      status,
      headers: {
        ...secureHeaders,
