...
export function page(
  ...
  let navigation = staff
    ...
    : `<a class="admin-nav-link" href="/admin/dashboard">Dashboard</a><div class="admin-nav-heading">Customers &amp; Cargo</div><a class="admin-nav-link" href="/admin/customers">Customers</a><a class="admin-nav-link" href="/admin/shipments">Shipments</a><a class="admin-nav-link" href="/admin/quotations">Quotations</a><a class="admin-nav-link" href="/admin/leads">Leads</a><div class="admin-nav-heading">Billing &amp; Finance</div><div class="admin-nav-group"><a class="admin-nav-link" href="/admin/finance">Overview</a><a class="admin-nav-sub" href="/admin/invoices">Invoices</a><a class="admin-nav-sub" href="/admin/finance/expenses">Expenses</a><a class="admin-nav-sub" href="/admin/finance/cash">Cash Flow &amp; Customer Credits</a></div><div class="admin-nav-heading">Pricing</div><div class="admin-nav-group"><a class="admin-nav-link" href="/admin/rates-guide">Rates &amp; Pricing</a><a class="admin-nav-sub" href="/admin/nihao-rates">Ni Hao Rates</a></div>${canWrite ? '<div class="admin-nav-heading">Admin &amp; Tools</div><a class="admin-nav-link" href="/admin/activity">Activity Log</a><a class="admin-nav-link" href="/admin/import-export">Import / Export</a>' : ""}<div class="admin-nav-heading">Account</div><a class="admin-nav-link" href="/cdn-cgi/access/logout">Sign Out</a>`;
