...
export async function quotationsPage(
  ...
  ${quotationMessageCopyScript()}
    ...
    const csrf = csrfToken(env, user.id, path),
      createFreight =
        url.searchParams.get("freight") === "Air Freight"
          ? "Air Freight"
          : "Sea Freight";
